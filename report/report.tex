...
\title{\textbf{chatops-gym: Validated Task Curricula for RL Training\\of Software Agents on a Real Chat Application}}
...
Hand-curated benchmarks address these properties with human review, which does not scale to generated curricula. \textsc{chatops-gym} addresses them by construction and by automated adversarial validation. Its contributions:
